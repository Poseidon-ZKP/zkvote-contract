...
import { Groth16SolidityProof, generate_zkp_nvote } from "./prover";
...
export type VoteRecordAndProof = {
  vote: Vote,
  R: PublicKey[],
  M: PublicKey[],
  proof: Groth16SolidityProof
};
...
export class Voter {
  ...
  /// not be made public
  public async cast_vote(proposalId: BigNumberish, vote: Vote): Promise<VoteRecordAndProof | null> {
